...
{
    public class CuttingDamageType : Damage, IPhysicalDamage
    {
        ...
        public CuttingDamageType(float minValue, float maxValue, int criticalDamageChance = 0, int criticalDamageModificator = 0) : base(minValue, maxValue)
        {
