...
{
    public class BleedingDamageType : Damage, IPhysicalDamage
    {
        ...
        public BleedingDamageType(float minValue, float maxValue, int criticalDamageChance = 0, int criticalDamageModificator = 0) : base(minValue, maxValue)
        {
