...
using Stats.SideStatsProvider.CriticalStrikeChance;
...
namespace Stats.Side
{
    public class CriticalStrikeChance
    {
        ...
        public CriticalStrikeChance(IBasicStats basicStats, Level level, SideStatsValueFactory valueFactory, IPolicyThatStatsIsFilled policyThatStatsIsFilled, IPolicyThatStatsIsOver policyThatStatsIsOver)
        {
            _basicStats = basicStats;
            _level = level;
            _sideStatProvider = new CriticalStrikeChanceProvider(basicStats, level, valueFactory);
