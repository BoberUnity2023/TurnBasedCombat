...
using Stats.SideStatsProvider.ProtectionFromStabbing;

namespace Stats.Side
{
    public class ProtectionFromStabbing: IPhysicalResist
    {
        ...
        public ProtectionFromStabbing(IBasicStats basicStats, Level level, SideStatsValueFactory valueFactory, IPolicyThatStatsIsFilled policyThatStatsIsFilled, IPolicyThatStatsIsOver policyThatStatsIsOver)
        {
            _basicStats = basicStats;
            _level = level;
            _sideStatProvider = new ProtectionFromStabbingProvider(basicStats, level, valueFactory);
