...
using Stats.SideStatsProvider.ProtectionFromElectricity;

namespace Stats.Side
{
    public class ProtectionFromElectricity : IMagicResist
    {
        ...
        public ProtectionFromElectricity(IBasicStats basicStats, Level level, SideStatsValueFactory valueFactory, IPolicyThatStatsIsFilled policyThatStatsIsFilled, IPolicyThatStatsIsOver policyThatStatsIsOver)
        {
            _basicStats = basicStats;
            _level = level;
            _sideStatProvider = new ProtectionFromElectricityProvider(basicStats, level, valueFactory);
