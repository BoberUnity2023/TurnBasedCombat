...
{
    public class Intelligence : IIncrementStatValue, IReducingStatValue , IChangingFillingPolicy , IBasicStats
    {
        ...
        public Intelligence(float value, IPolicyThatStatsIsFilled policyThatStatsIsFilled)
        {
            _value = value;
