...
{
    public class Durability : IIncrementStatValue, IReducingStatValue , IChangingFillingPolicy , IBasicStats
    {
        ...
        public Durability(float value, IPolicyThatStatsIsFilled policyThatStatsIsFilled)
        {
            _value = value;
