...
{
    public class MechanicalHands : IIncrementStatValue, IReducingStatValue, IBasicStats
    {
        ...
        public MechanicalHands(float value)
        {
            _value = value;
            _policyThatStatsIsFilled = new PolicyThatStatsIsFilled(1);
