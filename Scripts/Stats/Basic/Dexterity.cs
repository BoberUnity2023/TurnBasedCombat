...
{
    public class Dexterity : IIncrementStatValue, IReducingStatValue, IBasicStats
    {
        ...
        public Dexterity(float value, IPolicyThatStatsIsFilled policyThatStatsIsFilled)
        {
            _value = value;
