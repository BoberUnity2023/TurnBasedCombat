...
namespace Stats.SideStatsProvider.ProtectionFromIce
{
    public class ProtectionFromIceProvider : ISideStatProvider
    {
        private readonly SideStatsValueFactory _sideStatsValueFactory;
        private readonly IBasicStats _basicStats;
        private readonly Level _level;
        
        public ProtectionFromIceProvider(IBasicStats basicStats, Level level, SideStatsValueFactory sideStatsValueFactory)
        {
