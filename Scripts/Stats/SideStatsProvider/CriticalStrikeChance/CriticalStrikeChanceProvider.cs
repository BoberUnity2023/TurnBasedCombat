...
namespace Stats.SideStatsProvider.CriticalStrikeChance
{
    public class CriticalStrikeChanceProvider : ISideStatProvider
    {
        private readonly SideStatsValueFactory _sideStatsValueFactory;
        private readonly IBasicStats _basicStats;
        private readonly Level _level;
        
        public CriticalStrikeChanceProvider(IBasicStats basicStats, Level level, SideStatsValueFactory sideStatsValueFactory)
        {
